...
echo -e ${SRA}"\tNA\t"${runtime_circleres} >> /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/overall_analysis_02_onlycirclers
...
cp /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circlator/all_gathered/* /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circlator/all_gathered_02/
...
sort /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/startaligned_analysis.final |uniq | cut -f 2,4 |sort|uniq -c
...
startaligned_analysis <- read_delim("~/Desktop/Projects/2020_circleries/06_analysis/final_analysis/startaligned_analysis.final", delim = "\t", escape_double = FALSE,  trim_ws = TRUE,col_names = c("SRA","flye","circlator","circlers")) %>% filter(flye=="Y")
...
plot_complete_genome+plot_start+plot_circular+plot_speed+ plot_layout(nrow=1)
...
rm /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq
for gene in $(cut -f 1 /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circleres/tmp_07/${SRA}/tmp_${SRA}/Start_end_readmapping/long_read/mapping/all_contigs_mapping.paf)
do

echo $gene

grep "^@${gene} " -A 3 /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/SRA/${SRA}.fastq >> /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq

done

grep "^+$" /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq

gzip -c   /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq >  /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq.gz
...
/data/Project/2021_circlator/20220106_2020_circleries_tool/Circleries/Circleries.sh \
    ...
    -l /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq.gz \
    -t 8 \
    -o ${SRA} \
...
##-----------------one circular contigs +8 non-circular
SRA=SRR15376163
...
rm /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq
for gene in $(cut -f 1 /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circleres/tmp_07/${SRA}/tmp_${SRA}/Start_end_readmapping/long_read/mapping/all_contigs_mapping.paf|uniq)
do
...
grep "^+$" -c /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq

zcat   /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq >  /data/Project/2021_circlator/NCBI_analysis/test_cases/${name}_${SRA}.fastq.gz
