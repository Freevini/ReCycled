...
```{bash}
 ...
 rm -r /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/check_Restart/PROKKA/
 mkdir -p  /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/check_Restart/PROKKA/
 
for SRA in $(awk -F "\t" '{OFS="\t"}{if($4=="Y")print $1}' /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/startaligned_analysis.final )
do

echo -e ${SRA}

head -1 /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circleres/all_gathered_02/${SRA}.fasta

conda activate PROKKA

prokka --outdir /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/check_Restart/PROKKA/${SRA} --force --proteins proteins.faa --evalue 0.001 --addgenes   /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circleres/all_gathered_02/${SRA}.fasta --cpus 5
