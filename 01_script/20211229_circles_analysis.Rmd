...
scp -r vincent@130.223.51.66:/data/Project/2021_circlator/NCBI_analysis/SRA_analysis/SMILEY/all.depth /home/vincent/Desktop/Projects/2020_circleries/06_analysis/final_analysis/SMILEY/
...
all <- read_table2("~/Desktop/Projects/2020_circleries/06_analysis/final_analysis/SMILEY/all.depth",  col_names = FALSE)
...
tmp_2 <- rollapply(tmps_1$X3, width = 100000, by = 5000, FUN = median, align = "left")
...
ggplot(averaged_all_normalised,aes(x=bin_norm,y=coverage_norm,group=contig,color=contig,fill=contig))+geom_line()+theme_classic()+lims(y=c(0,1))
...
grep "${SRA}" /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/logs/SRA_biosample.names.sra.info_02
