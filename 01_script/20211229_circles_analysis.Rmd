...
/home/vincent/apps/sratoolkit.2.11.2-ubuntu64/bin/fastq-dump --stdout ${SRA} | gzip > /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/SRA/${SRA}.fastq.gz
...
mkdir -p /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circlator/${SRA}/
start=`date +%s`
...
echo -e ${SRA}"\t"${runtime_circlator} >> /data/Project/2021_circlator/NCBI_analysis/SRA_analysis/circlator/all_gathered/runtimes.circlator
